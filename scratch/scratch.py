...
# Load data
DATA_PATH = Path("data/guidewire-reconstruction-2/")
image_num = 23
...
def resample_curve_equidistant(points, distance=2.0):
    ...
    for _ in range(num_points):
        ...
        while not found:
            ...
            candidate_point = np.array([cs_x(t_current), cs_y(t_current), cs_z(t_current)])
...
if __name__ == "__main__":
    ...
    ax.plot(reproj_opt[:, 0], reproj_opt[:, 1], reproj_opt[:, 2], 'b.', label='Reprojected')
